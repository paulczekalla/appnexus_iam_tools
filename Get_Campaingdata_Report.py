...
def main():
    ...
    # Bulk Feed
    report_columns = ["day", "seller_member_id", "buyer_member_id", "advertiser_id","line_item_id","campaign_id", "creative_id", "size", "publisher_id", "site_id", "placement_id", "bid_type", "pub_rule_id", "revenue_type", "payment_type", "imps", "clicks", "post_click_convs", "post_view_convs", "total_convs", "profit", "revenue", "media_cost", "total_network_rpm", "ppm"]
